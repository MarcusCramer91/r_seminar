...
#' @name bbob_output_interpreter
#' @title read and interpret data from a bbob experiment
#' @description
...
#' @return \code{readOutput} returns a list that contains the following components:
...
#'   \item{sdbest}{standard deviation of all best fitness values (sd of \code{allBest}).}
#'   \item{allRuns}{amount of iterations of each processed function instance that has been required for optimization.}
#'   \item{longestRun}{overall highest required amount of iterations of all function instances.}
#'   \item{shortestRun}{overall lowest required amount of iterations of all function instances.}
#'   \item{avgRuns}{average required iterations of all functions instances.}
#'   \item{sdRuns}{standard deviation of required iterations of all function instances (sd of\code{allRuns}).}
#'   \item{allRunsEval }{amount of function evaluations of each processed function instance that has been required for optimization.}
#'   \item{longestRunEval}{overall highest required amount of function evaluations of all function instances.}
#'   \item{shortestRunEval}{overall lowest required amount of function evaluations of all function instances.}
#'   \item{avgRunEval}{average required function evaluations of all functions instances.}
#'   \item{sdRunsEval}{standard deviation of required function evaluations of all function instances (sd (\code{allRunsEval}).}
#'   \item{allStagnations}{amount of final iterations without improvement in the fitness value.}
#'   \item{longestStagnation}{highest amount of iterations without improvement in the fitness value of all function instances.}
#'   \item{shortestStagnation}{lowest amount of iterations without improvement in the fitness value of all function instances..}
#'   \item{avgStagnation}{average amount of final iterations without improvement in the fitness value.}
#'   \item{sdStagnation}{standard deviation of the amount of final iterations 
#'   without improvement in the fitness value of all function instances (sd of \code{allStagnation}).}
#'   \item{allConvergence}{Number of offspring generaded in each generation.}
#'   \item{avgConvergence}{Number of offspring generaded in each generation.}
#'   \item{allRestarts}{Number of offspring generaded in each generation.}
#'   \item{t_test_termination}{Number of offspring generaded in each generation.}
#'   \item{chi_test_termination}{Number of offspring generaded in each generation.}
#'   \item{functionID}{Number of offspring generaded in each generation.}
#'   \item{dimension}{Number of offspring generaded in each generation.}
#' @export
######################################################################
