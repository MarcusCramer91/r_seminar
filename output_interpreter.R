...
#' @title output interpretation of bbob data
#' @description
...
#' @title aggregated output interpretation of bbob data
#' @description
...
#' @title load all single bbob results of a folder
#' @description 
...
#' @param usedFunctions
#' the function identifiers for bbob data exists and interpretation is desired.
...
#' (see \code{readOutput}) for details on the lists' elements.
#' @export
...
#returns the number of functions per iteration that are not yet stopped
